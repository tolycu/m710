...
@interface M710_ScanViewController ()<AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
{
    CGFloat layout_W;
    CGFloat TOP;
    CGFloat LEFT;
...
@implementation M710_ScanViewController
