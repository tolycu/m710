...
@interface Szero_BaseNavController ()

@end

@implementation Szero_BaseNavController
...
- (UIViewController *)popViewControllerAnimated:(BOOL)animated {
    Szero_BaseViewController *vc = self.viewControllers.lastObject;
